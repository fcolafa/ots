...
class CCheckBoxColumn extends CGridColumn
{
	...
	public $headerCheckBoxVisible= false;
...
EOD;
	...
	protected function renderHeaderCellContent()
	{
		...
		$item = '';
		if($this->selectableRows===null && $this->grid->selectableRows>1 && $this->headerCheckBoxVisible)
			$item = CHtml::checkBox($this->id.'_all',false,array('class'=>'select-on-check-all'));
		elseif($this->selectableRows>1 && $this->headerCheckBoxVisible)
