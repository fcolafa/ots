...
<div class="row-fluid" >
    ...
    <div class="container-fluid" valign="center"  style="padding-top:0%;">
        <div>
            ...
            <div align="center"  class="messageButtonb blue">
                    <?php echo CHtml::link('<img src=' . '"' . Yii::app()->theme->baseUrl . '/img/big_icons/icon-xls.png" alt="Reporteria"  width="15%" />', array('reports/index')); ?>
                    <div class="dashIconText"><?php echo CHtml::link('<h4>Reportes</h4>', array('reports/index')); ?></div>
            </div>
