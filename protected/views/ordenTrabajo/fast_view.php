...
$this->menu=array(
	...
	//array('label'=>'Ver Personal', 'url'=>array('view', 'id'=>$model->ID_PERSONA)),
...
<?php $this->renderPartial('_form', array('model'=>$model, 'usuario'=>$usuario,'aprovacion'=>$aprovacion, 'aprobados'=>$aprobados,)); ?>