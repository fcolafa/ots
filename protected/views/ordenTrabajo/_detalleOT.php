                    ...
                    <tr>				  	<!-- style="display:none;" -->
                        <td>
                            ...
                            if ($new_sub_item->isNewRecord && ($new_sub_item->ID_OT > 0)):
                                ...
                                if ($sql->NUMERO_SUB_ITEM == NULL)
                                    $ultimo = 1;
                                else
                                    $ultimo = $sql->NUMERO_SUB_ITEM + 1;
                            else:
                        ...
                        <td><?php
                            $lista_dos = array();
                            echo $form->dropDownList($new_sub_item, 'ID_CCC', $lista_dos, array(
                                'ajax' => array(
                                    'type' => 'POST',
                        ...
                        <td><?php
                            ...
                            $lista_tres = array();
                            echo $form->dropDownList($new_sub_item, 'ID_SCC', $lista_tres, array(
                                'ajax' => array(
                                    'type' => 'POST',
                        ...
                        <td>
                            <?php
                            echo $form->dropDownList($new_sub_item, 'ID_SEC', $this->getCC(), array('class' => 'span12'));
            ...
            <tbody> <!--  subitem creados -->
                ...
                foreach ($sub_items as $sub):
                    ...
                    <tr>
                        ...
                        <td class="text-right"> <?= $this->getFormat($model->tipo_moneda->TIPO_MONEDA, $sub->COSTO_CONTRATISTA) ?> </td>
