	...
	<div class="mod_insumo">
		...
		<div class="col-3">
			...
			<?php
	            ...
	            echo $form->dropDownList($model,'ID_CCC',$lista_dos,
	                    array(
		...
		<div class="col-3">
			...
			<?php
	            ...
	            echo $form->dropDownList($model,'ID_SCC',$lista_tres,
	                array(
	                    'ajax'=>array(
	                      	'type'=>'POST',
