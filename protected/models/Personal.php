...
class Personal extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('EMAIL', 'unique'),
            array('DEBAJA, _sendmail, ID_EMPRESA, ID_CARGO, ID_DEPARTAMENTO, ES_USUARIO, APRUEBA_DOCS', 'numerical', 'integerOnly' => true),
            ...
            array('DEBAJA, _sendmail, URL_FIRMA, _firma, _company, ID_PERSONA, ID_EMPRESA, RUT_PERSONA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO, EMAIL, ID_CARGO, ID_DEPARTAMENTO, ES_SUPERVISOR, ES_USUARIO, APRUEBA_DOCS, ESTADO_TRABAJADOR', 'safe', 'on' => 'search'),
        );
    }
    ...
    public static function getPersonal() {
        $criteria = new CDbCriteria();
        $criteria->condition = "ID_EMPRESA=" . Yii::app()->getSession()->get('id_empresa') . " AND DEBAJA<>1";
