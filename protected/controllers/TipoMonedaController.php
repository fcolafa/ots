...
class TipoMonedaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TipoMoneda']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_TIPO_MONEDA));
		}
	 ...
	 * @return TipoMoneda the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TipoMoneda::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TipoMoneda $model the model to be validated
	 */
